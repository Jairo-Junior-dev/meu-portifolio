...
import IMAGE_BFE from "../../assets/babiloniafrontend.png"

import Video33 from "../../assets/3 Doors Down - Here Without You (Official Music Video).mp4"
...
const pathsImage: string[] = [IMAGE_PSJ,IMAGE_BFE]; 
...
const cards: CardsProps[] = [
  ...
  },
  {
    ...
    image: pathsImage[1],
    categoriaProjeto: [TypeProject.ANGULAR],
    integrantes:[{githubPath:"https://github.com/Jairo-Junior-dev" , nome:"Jairo Pinheiro"},
